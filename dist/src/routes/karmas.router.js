...
exports.karmaRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const result = yield ((_d = database_service_1.collections.karmas) === null || _d === void 0 ? void 0 : _d.insertOne(newKarma));
        result
...
exports.karmaRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const query = { _id: new mongodb_1.ObjectId(id) };
        const result = yield ((_f = database_service_1.collections.karmas) === null || _f === void 0 ? void 0 : _f.updateOne(query, { $set: updatedKarma }));
        result
...
exports.karmaRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const query = { _id: new mongodb_1.ObjectId(id) };
        const result = yield ((_h = database_service_1.collections.karmas) === null || _h === void 0 ? void 0 : _h.deleteOne(query));
